...
module.exports = {
  ...
  "module": {
    "rules": [
      ...
      {
        "exclude": [
          path.join(process.cwd(), "src/assets/css/prism.min.css"),
          path.join(process.cwd(), "node_modules/sweetalert2/dist/sweetalert2.min.css"),
          path.join(process.cwd(), "src/assets/css/wizard.css"),
          path.join(process.cwd(), "src/assets/css/quill.snow.css"),
          path.join(process.cwd(), "src/assets/css/quill.bubble.css"),
          path.join(process.cwd(), "src/assets/css/hopscotch.css"),
          ...
          path.join(process.cwd(), "node_modules/videogular2/fonts/videogular.css"),
          ...
          path.join(process.cwd(), "src/assets/sass/app.scss"),
  ...
  "plugins": [
    ...
    new ScriptsWebpackPlugin({
      ...
      "scripts": [
        "/home/monkeycoderz/JROTC/jrotc-website/node_modules/jquery/dist/jquery.min.js",
        "/home/monkeycoderz/JROTC/jrotc-website/src/assets/vendor/pace/pace.min.js",
        "/home/monkeycoderz/JROTC/jrotc-website/src/assets/js/perfect-scrollbar.jquery.min.js"
      ],
      "basePath": "/home/monkeycoderz/JROTC/jrotc-website"
    }),
